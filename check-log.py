...
PATTERNS = {
    ...
    rb"\bwarning\b": [
        ...
        # `um` 6.12.y many, many `warning: performing pointer arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]`.
        # TODO: enable when we have support for per-run/arch/...
        #b"./include/asm-generic/io.h:",

        # loongarch64 6.12.y many warnings.
        # TODO: enable when we have support for per-run/arch/...
        #b": sibling call from callable instruction with modified stack frame",
